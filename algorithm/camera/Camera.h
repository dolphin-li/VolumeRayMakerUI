...
public:
	...
	* */
	...
	// a hacking method to adapt the RenderingForRCNN data.
	// assuming the scene is centered at (0,0,0)
	void setModelViewMatrixFromEuler(float azimuthInDegree, 
	...
	* */
	...
	void arcballSetCenter(ldp::Float3 p);
	ldp::Float3 arcballGetCenter()const;
